...
public class DialogEditor : EditorWindow
{
    ...
    public Dialog CurrentDialog
    {
        ...
        set
        {
            ...
            if (m_defaultNodeStyle == null || m_selectedNodeStyle == null) LoadStyles(); 
            m_currentDialog.InitEditorSettings(m_defaultNodeStyle, m_selectedNodeStyle); 
        }
    }
    #endregion
    ...
    {
        LoadStyles(); 
        if (CurrentDialog != null) CurrentDialog.InitEditorSettings(m_defaultNodeStyle, m_selectedNodeStyle);
    }
