...
{
    [Serializable]
    public class DialogueCondition : DialogueNode
    {
...
#if UNITY_EDITOR
        private Action<DialogueCondition> m_onRemoveDialogCondition = null;
        private bool m_displayLUACode = false;
        private List<Condition> m_conditionsConverted = new List<Condition>();
        private DialoguesSettings m_dialogSettings;
        ...
        #region Constructor 
#if UNITY_EDITOR
        public DialogueCondition(Vector2 _nodePosition, Action<DialogueCondition> _onRemoveCondition, GUIStyle _nodeStyle, GUIStyle _selectedStyle, GUIStyle _connectionPointStyle, GUIContent _conditionIcon, GUIContent _pointIcon)
        {
        ...
        public void Draw(List<DialogueSet> _otherSets, List<DialogueCondition> _otherConditions, Action<DialogueNode> _onInDialogNodeSelected, Action<DialogueCondition, bool> _onOutDialogNodeSelected)
        {
