...
{
    [Serializable]
    public class DialogueStarter : DialogueNode
    {
        ...
        #region Constructor
#if UNITY_EDITOR
        public DialogueStarter(Vector2 _nodePosition, GUIStyle _normalStyle, GUIStyle _selectedStyle, GUIStyle _connectionPointStyle, GUIContent _startingSetIcon, GUIContent _pointIcon)
        {
        ...
        #region Methods
#if UNITY_EDITOR
        public void Draw(List<DialogueSet> _otherSets, List<DialogueCondition> _otherConditions, Action<StarterPair> _onOutPointSelected)
        {
...
#if UNITY_EDITOR
        public float Draw(Vector2 _statringPoint, List<DialogueSet> _otherSets, List<DialogueCondition> _otherConditions, Action<StarterPair> _onOutPointSelected, GUIStyle _outPointStyle, GUIContent _outPointIcon)
        {
            Rect _r = new Rect(_statringPoint.x, _statringPoint.y, DialogueNode.CONTENT_WIDTH, 1.0f);
            ...
            OutPointRect = new Rect(_statringPoint.x + DialogueNode.CONTENT_WIDTH - 30, (_statringPoint.y + _r.y) / 2, 38, 38);
